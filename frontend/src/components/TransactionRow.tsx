    ...
    <div className="flex items-center justify-between gap-3 px-4 py-3">
        ...
        <span
          className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full ${
            isIncome
              ...
              : 'bg-rose-100 text-rose-600 dark:bg-red-600/20 dark:text-red-300'
          }`}
        >
      ...
      <div className="flex shrink-0 items-center gap-2">
        <span className="whitespace-nowrap text-right">
          <span className={`block text-sm font-bold ${isIncome ? 'text-brand-600 dark:text-brand-400' : 'text-rose-600 dark:text-red-400'}`}>
            {isIncome ? '+' : '−'}
        ...
        {onDelete && (
          <div className="flex items-center">
            <Link
              ...
              className="rounded-lg p-2 text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200"
            >
